...
const cargarImagen = (id, nombre, ruta, descripcion) => {
    ...
    // Marcar imagen del carousel como activa
    if (galeria$4.querySelectorAll(".galeria__carousel-slide").length > 0) {
        // Elimianar la calse actice de cualquier slide
...
const cargarAnteriorSiguiente = (direccion) => {
    ...
    if (direccion === "siguiente") {
        ...
        ++indexImagenActual;
        indexValid = fotos[indexImagenActual] ? indexImagenActual : (fotos.length - indexImagenActual);

        const { id, nombre, ruta, descripcion } = fotos[indexValid];
...
const carousel = (direccion) => {
    ...
    const observer = new IntersectionObserver((entradas) => {
        ...
        // Dejar de observar los elementos del carousel
    ...
    // Observar los elementod del carousel
    const slides = galeria$1.querySelectorAll(".galeria__carousel-slide");
    slides.forEach((slide) => {
